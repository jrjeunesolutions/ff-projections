...
def export(season: int, as_of: str) -> Path:
    ...
    # Rookie enrichment now runs inside ``project_rookies`` (so the
    # internal share-partitioning sees enriched teams). The ScoringProjection
    # frame already carries enriched player_id/team for rookies — no
